# DriverPass-Project
A repository containing the documents produced by the DriverPass Project.

# Questions and Answers
## Who was the client? What type of system did they want you to design?
<p>The owner of DriverPass, Liam, stated they want the system designed to enhance driver training by reducing failure rates in driver tests through online classes and practice tests.</p>

## What did you do particularly well?
<p>I did particularly well in identifying the core system requirements from the meetings.</p>

## If you could choose one part of your work on these documents to revise, what would you pick? How would you improve it?
<p>I think I would choose to update on the class diagram based on the feedback I received. I noticed some of the core parts of the overall system were missing. There wasn't anything representing the structure of the quizzes and tests. I'd also update the class relationships to match more closely to the system requirements.</p>
